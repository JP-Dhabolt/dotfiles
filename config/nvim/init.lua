...
require('lazy').setup({
  ...
  { -- nerdcommenter
    ...
    config = function()
      vim.keymap.set('v', '<C-/>', '<Plug>NERDCommenterToggle<CR>', { desc = 'Toggle commented line' })
      vim.keymap.set('n', '<C-/>', '<Plug>NERDCommenterToggle<CR>', { desc = 'Toggle commented line' })
  ...
  require 'kickstart.plugins.oil_nvim',

...
require("lazy").setup({
	...
	{ -- nerdcommenter
		...
		config = function()
			vim.keymap.set("v", "<C-/>", "<Plug>NERDCommenterToggle<CR>gv", { desc = "Toggle commented line" })
			vim.keymap.set("n", "<C-/>", "<Plug>NERDCommenterToggle<CR>gv", { desc = "Toggle commented line" })
